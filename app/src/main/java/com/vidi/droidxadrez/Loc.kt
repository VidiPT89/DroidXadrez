...
private val STRINGS: Map<AppLanguage, Map<String, String>> = mapOf(
    AppLanguage.PT to mapOf(
        ...
        "mpQuickPlay" to "⚡ Jogo Rápido",
        "mpQuickPlayDesc" to "Entra logo e espera por um adversário — sem código.",
        ...
        "mpErrorLobbyFull" to "Todas as salas rápidas estão ocupadas. Tenta criar uma sala normal.",
    ...
    AppLanguage.EN to mapOf(
        ...
        "mpQuickPlay" to "⚡ Quick Play",
        "mpQuickPlayDesc" to "Jump in and wait for an opponent — no code needed.",
        ...
        "mpErrorLobbyFull" to "All quick-play rooms are full right now. Try creating a normal room.",
